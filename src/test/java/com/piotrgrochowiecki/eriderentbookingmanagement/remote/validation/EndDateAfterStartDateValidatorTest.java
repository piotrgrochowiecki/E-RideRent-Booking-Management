...
class EndDateAfterStartDateValidatorTest {
    ...
    @Test
    @DisplayName("Given bookingRequestDto with endDate before startDate," +
    ...
    void shouldAddOneViolationToTheSet() {
        ...
        LocalDate endDate = LocalDate.of(2041, 9, 9);
    ...
    @Test
    @DisplayName("Given bookingRequestDto with endDate after startDate, " +
                 "when validation occurs" +
